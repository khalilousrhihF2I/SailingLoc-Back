    ...
    public class BookingService : IBookingService
    {
        ...
        public async Task<BookingDto> CreateBookingAsync(CreateBookingDto dto)
        {
            ...
            var overlappingAvailability = await _db.BoatAvailabilities
                ...
                .AsNoTracking()
                .AnyAsync();
            if (overlappingAvailability) throw new InvalidOperationException("Le bateau n'est pas disponible pour la p�riode s�lectionn�e");
            ...
            var overlappingBookings = await _db.Bookings
                ...
                .AsNoTracking()
                .AnyAsync();
            if (overlappingBookings) throw new InvalidOperationException("Le bateau est d�j� r�serv� pour la p�riode s�lectionn�e");
            ...
            var overlappingRenterBookings = await _db.Bookings
                ...
                .AsNoTracking()
                .AnyAsync();
            if (overlappingRenterBookings) throw new InvalidOperationException("Vous avez d�j� une r�servation qui chevauche la p�riode s�lectionn�e");
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"Erreur lors de l'envoi des notifications de r�servation: {ex.Message}");
            }
        ...
        public async Task<BookingDto> UpdateBookingAsync(string id, UpdateBookingDto dto)
        {
            ...
            if (existing == null) throw new KeyNotFoundException("R�servation introuvable");
            // only status allowed
